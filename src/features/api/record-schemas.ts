...
export const recordSchemas: Record<string, SchemaObject> = {
  ...
  features: {
    ...
    properties: {
      ...
      photographer_plan_id: {
        type: 'string',
        description: 'photographer plan id',
        format: 'uuid',
        nullable: true,
      },
      code: {
  ...
  galleries: {
    ...
    required: ['id', 'booking_id', 'created_at', 'updated_at'],
  },
  feedbacks: {
    type: 'object',
    properties: {
  ...
  location_sessions: {
    ...
    required: ['id', 'booking_id', 'active', 'created_at', 'updated_at'],
  },
  conversations: {
    type: 'object',
    properties: {
  ...
  message_reads: {
    ...
    required: ['id', 'message_id', 'user_id', 'created_at', 'updated_at'],
  },
  notifications: {
    type: 'object',
    properties: {
    ...
    required: ['id', 'user_id', 'title', 'body', 'created_at', 'updated_at'],
  },
  reports: {
    type: 'object',
    properties: {
